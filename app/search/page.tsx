    ...
    <div className="container py-8 space-y-8">
      ...
      <div className="space-y-6">
        <div className="space-y-2">
          <h1 className="text-4xl font-bold tracking-tight gradient-text">Search</h1>
          <p className="text-xl text-muted-foreground max-w-[800px]">
            Find action figure news, reviews, and announcements
          </p>
        </div>
          ...
          <form className="flex gap-2">
            <div className="relative flex-1">
              ...
              <Input
                ...
                name="q"
                defaultValue={query}
                placeholder="Search for action figures, reviews, news..."
            ...
            <div className="rounded-lg border border-primary/20 p-4 bg-card/80 backdrop-blur-sm">
              ...
              <div className="space-y-3">
                <h4 className="font-medium text-sm text-muted-foreground flex items-center">
                  <Tag className="mr-2 h-4 w-4" /> Popular Tags
                </h4>
            ...
            {query && paginatedResults.length === 0 && (
              <div className="text-center py-12 space-y-4">
                ...
                <p className="text-muted-foreground max-w-md mx-auto">
                  We couldn't find any posts matching your search. Try using different keywords or removing filters.
                </p>
              </div>
            )}
