...
export default function HomePageClient({ featuredPost, recentPosts, newReleases }: HomePageClientProps) {
  ...
  return (
    <div className="container py-8 space-y-12">
      ...
      <section className="space-y-6 py-10 relative overflow-hidden">
        ...
        <div className="relative z-10">
          <h1 className="text-5xl font-bold tracking-tight sm:text-6xl text-center neon-text">
            {t('home.hero.title.first')} <span className="text-primary">{t('home.hero.title.highlight')}</span> {t('home.hero.title.last')}
          </h1>
          ...
          <div className="flex gap-4 mt-6 justify-center">
            <Button size="lg" className="bg-primary hover:bg-primary/90 text-primary-foreground">
              {t('home.hero.buttons.reviews')} <Star className="ml-2 h-4 w-4" />
            </Button>
            <Button size="lg" variant="outline" className="border-primary text-primary hover:bg-primary/10">
              {t('home.hero.buttons.newReleases')} <Zap className="ml-2 h-4 w-4" />
            </Button>
          </div>
        </div>
      </section>
          ...
          <div className="relative">
            ...
            <div className="absolute bottom-0 left-0 p-6 space-y-2">
              ...
              <Link href={`/posts/${featuredPost.slug}`}>
                ...
                >
                  {t('buttons.readMore')} <ArrowRight className="h-4 w-4" />
                </Button>
              </Link>
            </div>
          </div>
      ...
      <section className="space-y-4 relative">
        ...
        <div className="flex items-center justify-between">
          <h2 className="text-3xl font-bold tracking-tight gradient-text">{t('home.recentPosts.title')}</h2>
          <Link href="/posts">
      ...
      {/* Categories */}
      <section className="space-y-4">
        <h2 className="text-3xl font-bold tracking-tight gradient-text-reverse">{t('home.categories.title')}</h2>
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          <Link href="/categories/sh-figuarts">
            <Card className="overflow-hidden h-full hover:shadow-md transition-shadow border-primary/20 card-hover-effect bg-card/80 backdrop-blur-sm">
              <div className="relative aspect-square">
                <Image src="/placeholder.svg?height=400&width=400" alt={t('nav.shFiguarts')} fill className="object-cover" />
                <div className="absolute inset-0 bg-gradient-to-t from-background to-transparent" />
                <div className="absolute bottom-0 left-0 p-4">
                  <h3 className="text-xl font-bold text-primary neon-text">{t('nav.shFiguarts')}</h3>
                </div>
              </div>
            </Card>
          </Link>
          <Link href="/categories/figma">
            <Card className="overflow-hidden h-full hover:shadow-md transition-shadow border-primary/20 card-hover-effect bg-card/80 backdrop-blur-sm">
              <div className="relative aspect-square">
                <Image src="/placeholder.svg?height=400&width=400" alt={t('nav.figma')} fill className="object-cover" />
                <div className="absolute inset-0 bg-gradient-to-t from-background to-transparent" />
                <div className="absolute bottom-0 left-0 p-4">
                  <h3 className="text-xl font-bold text-primary neon-text">{t('nav.figma')}</h3>
                </div>
              </div>
            </Card>
          </Link>
          <Link href="/categories/mafex">
            <Card className="overflow-hidden h-full hover:shadow-md transition-shadow border-primary/20 card-hover-effect bg-card/80 backdrop-blur-sm">
              <div className="relative aspect-square">
                <Image src="/placeholder.svg?height=400&width=400" alt={t('nav.mafex')} fill className="object-cover" />
                <div className="absolute inset-0 bg-gradient-to-t from-background to-transparent" />
                <div className="absolute bottom-0 left-0 p-4">
                  <h3 className="text-xl font-bold text-primary neon-text">{t('nav.mafex')}</h3>
                </div>
              </div>
            </Card>
          </Link>
          <Link href="/categories/revoltech">
            <Card className="overflow-hidden h-full hover:shadow-md transition-shadow border-primary/20 card-hover-effect bg-card/80 backdrop-blur-sm">
              <div className="relative aspect-square">
                <Image src="/placeholder.svg?height=400&width=400" alt={t('nav.revoltech')} fill className="object-cover" />
                <div className="absolute inset-0 bg-gradient-to-t from-background to-transparent" />
                <div className="absolute bottom-0 left-0 p-4">
                  <h3 className="text-xl font-bold text-primary neon-text">{t('nav.revoltech')}</h3>
                </div>
              </div>
            </Card>
          </Link>
      ...
      <section className="rounded-lg bg-muted/30 p-6 md:p-8 border border-primary/20 backdrop-blur-sm relative overflow-hidden">
        ...
        <div className="grid gap-4 md:grid-cols-2 md:gap-8 relative z-10">
          <div className="space-y-2">
            <h2 className="text-2xl font-bold gradient-text">{t('home.newsletter.title')}</h2>
